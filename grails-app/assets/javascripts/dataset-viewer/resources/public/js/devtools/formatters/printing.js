...
var len__26280__auto___27457 = arguments.length;
var i__26281__auto___27458 = (0);
while(true){
if((i__26281__auto___27458 < len__26280__auto___27457)){
args__26287__auto__.push((arguments[i__26281__auto___27458]));

var G__27459 = (i__26281__auto___27458 + (1));
i__26281__auto___27458 = G__27459;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26288__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27454){
var G__27455 = cljs.core.first.call(null,seq27454);
var seq27454__$1 = cljs.core.next.call(null,seq27454);
var G__27456 = cljs.core.first.call(null,seq27454__$1);
var seq27454__$2 = cljs.core.next.call(null,seq27454__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__27455,G__27456,seq27454__$2);
});
...
if(cljs.core.truth_((function (){var or__25172__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25778__auto__,writer__25779__auto__,opt__25780__auto__){
return cljs.core._write.call(null,writer__25779__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25160__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25160__auto__){
var or__25172__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25172__auto__)){
return or__25172__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27460_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__27460_SHARP_));
})))){
...
var map__27469 = opts;
var map__27469__$1 = ((((!((map__27469 == null)))?((((map__27469.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27469.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27469):map__27469);
var markup_db = cljs.core.get.call(null,map__27469__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25172__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e27473){var e__26371__auto__ = e27473;
return false;
}})();
if(cljs.core.truth_(or__25172__auto__)){
return or__25172__auto__;
...
}catch (e27475){var e__26371__auto__ = e27475;
return false;
}}
})())){
...
var _STAR_current_state_STAR_27480 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__27481 = opts;
...
var markup_db = cljs.core.get.call(null,map__27481__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_27480;
}});
...
;
var temp__4655__auto___27486 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___27486)){
var managed_print_level_27487 = temp__4655__auto___27486;
var _STAR_print_level_STAR_27485_27488 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_27487;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_27485_27488,managed_print_level_27487,temp__4655__auto___27486,writer,opts,job_fn){
return (function (p1__27483_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27483_SHARP_,null);
});})(_STAR_print_level_STAR_27485_27488,managed_print_level_27487,temp__4655__auto___27486,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_27485_27488;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1487092379379