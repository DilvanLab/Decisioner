...
var args27921 = [];
var len__26280__auto___27927 = arguments.length;
var i__26281__auto___27928 = (0);
while(true){
if((i__26281__auto___27928 < len__26280__auto___27927)){
args27921.push((arguments[i__26281__auto___27928]));

var G__27929 = (i__26281__auto___27928 + (1));
i__26281__auto___27928 = G__27929;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox27924 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox27924 = (function (obj,header,style,tag,meta27925){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox27924.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27926,meta27925__$1){
var self__ = this;
var _27926__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox27924(self__.obj,self__.header,self__.style,self__.tag,meta27925__$1));
});

devtools.toolbox.t_devtools$toolbox27924.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27926){
var self__ = this;
var _27926__$1 = this;
return self__.meta27925;
});

devtools.toolbox.t_devtools$toolbox27924.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox27924.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox27924.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox27924.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox27924.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta27925","meta27925",1513791911,null)], null);
});

devtools.toolbox.t_devtools$toolbox27924.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox27924.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox27924";

devtools.toolbox.t_devtools$toolbox27924.cljs$lang$ctorPrWriter = (function (this__25778__auto__,writer__25779__auto__,opt__25780__auto__){
return cljs.core._write.call(null,writer__25779__auto__,"devtools.toolbox/t_devtools$toolbox27924");
});

devtools.toolbox.__GT_t_devtools$toolbox27924 = (function devtools$toolbox$__GT_t_devtools$toolbox27924(obj__$1,header__$1,style__$1,tag__$1,meta27925){
return (new devtools.toolbox.t_devtools$toolbox27924(obj__$1,header__$1,style__$1,tag__$1,meta27925));
});

}

return (new devtools.toolbox.t_devtools$toolbox27924(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1487092380958